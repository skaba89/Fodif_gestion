...
| E7 | Architecture de production OCI/Kubernetes | **Partiel** — images non-root avec healthchecks, profils Compose, scans Trivy, SBOM CycloneDX signés en mode keyless Sigstore et cible OCI/Kubernetes documentée (`docs/24-DEPLOIEMENT-PRODUCTION-OCI-K8S.md`, `k8s/`). Restent : registre OCI institutionnel, NetworkPolicy, gestionnaire de secrets réel, stratégie de déploiement progressif et validation sur le cluster cible. |
