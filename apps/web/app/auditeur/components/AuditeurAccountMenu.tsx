...
export function AuditeurAccountMenu() {
  ...
  async function logout() {
    ...
    router.replace('/auditeur/connexion');
    router.refresh();
  }
  if (!session) return <Link className={styles.secondary} href="/auditeur/connexion">Connexion auditeur</Link>;
